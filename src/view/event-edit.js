...
import { convertToBasicime,getItemFromItemsById,convertToUpperCase } from '../utlis.js';
...
const eventEditTemplate = (tripPoint) =>{
  ...
  return (
    ...
    <section class="event__details">
      <section class="event__section  event__section--offers">
        <h3 class="event__section-title  event__section-title--offers">${visibility}</h3>
...
export default class EventEdit {
  ...
  get template () {
    return eventEditTemplate(this.#tripPoint);
  }
