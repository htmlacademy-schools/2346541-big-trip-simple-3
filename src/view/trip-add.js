...
import { convertToFormDate,convertToUpperCase,getItemFromItemsById } from '../utlis.js';
import {getArrayFromType} from '../mosk/consts.js';
function createOffersTemplate(offers, type) {
  return getArrayFromType(type).map((offer) => {
  ...
  <section class="event__details">
    ...
    <section class="event__section  event__section--destination">
      ...
      <div class="event__photos-container">
        ...
        <img class="event__photo" src="${createDestinationPicsTemplate(destination)}" alt="Event photo">
        </div>
      </div>
    </section>
  </section>
...
export default class CreatTrip {
  #element = null;
  #tripPoint = null;
